...
log_file = '2050_middle_rd2_optimization_output.txt'
...
with open('2050_middle_rd2_objective_constant.txt', 'w') as f:
    f.write(str(n.objective_constant))

n.export_to_netcdf('optimized_2050_rd2_network.nc')
n.stores.to_csv('stores_2050_rd2.csv', index=False)
n.storage_units.to_csv('storage_units_2050_rd2.csv', index=False)
n.generators.to_csv('generators_2050_rd2.csv', index=False)
...
supply_data.to_csv('2050_middle_rd2_hourly_energy_supply.csv', index=True)

print("2050_middle_rd2_hourly_energy_supply.csv")

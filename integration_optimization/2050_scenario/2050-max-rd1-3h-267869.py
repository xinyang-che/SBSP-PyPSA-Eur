...
log_file = '2050_max_rd1_optimization_output.txt'
...
with open('2050_max_rd1_objective_constant.txt', 'w') as f:
    f.write(str(n.objective_constant))

#9
statistics = n.statistics().dropna()

statistics.to_csv('2050_max_rd1_statistics_cleaned.csv', index=True)

print("save to 'statistics_cleaned.csv'")

n.export_to_netcdf('optimized_2050_max_rd1_267869_network.nc')
n.stores.to_csv('stores_2050_max_rd1_267869.csv', index=False)
n.storage_units.to_csv('storage_units_2050_max_rd1_267869.csv', index=False)
n.generators.to_csv('generators_2050_max_rd1_267869.csv', index=False)
...
supply_data.to_csv('2050_max_rd1_hourly_energy_supply.csv', index=True)

print("2050_max_rd1_hourly_energy_supply.csv")
...
output_file = 'active_rd1_SBSP_buses_max.txt'
...
output_file = 'sbsp_rd1_p_nom_opt_results_max.txt'
with open(output_file, 'w') as f:
...
with open("total_cost_max_summary_rd1_267869.txt", "w") as f:

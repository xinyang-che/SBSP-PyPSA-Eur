...
log_file = '2050_middle_rd2_200000_optimization_output.txt'
...
with open('2050_middle_rd2_200000_objective_constant.txt', 'w') as f:
    f.write(str(n.objective_constant))

n.export_to_netcdf('optimized_2050_rd2_200000_network.nc')
n.stores.to_csv('stores_2050_rd2_200000.csv', index=False)
n.storage_units.to_csv('storage_units_2050_rd2_200000.csv', index=False)
n.generators.to_csv('generators_2050_rd2_200000.csv', index=False)
#14
import matplotlib.pyplot as plt
import pandas as pd
...
supply_data.to_csv('2050_middle_rd2_200000_hourly_energy_supply.csv', index=True)

print("2050_middle_rd2_200000_hourly_energy_supply.csv")
...
output_file = 'active_rd2_200000_SBSP_buses.txt'
...
output_file = 'sbsp_rd2_200000_p_nom_opt_results.txt'
with open(output_file, 'w') as f:
...
with open("total_cost_summary_rd2_200000.txt", "w") as f:
